...
{
    public partial class Basic_2 : Form
    {
        ...
        public Basic_2(int inputAmount)
        {
            InitializeComponent();
        ...
        private void Basic_2_Load(object sender, EventArgs e)
        {
            keySets = new char[8];
        ...
        private void Basic_2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (current_index < targetInputs.Count())
            {
                if (e.KeyChar == targetInputs[current_index])
                {
                    ...
                    else
                    {
                        ...
                        var result = new Lesson_result("Basic_2", targetInputs.Count(), entries, errors, accuracy, Time_Track.Text, wpm);
                        result.Show();
                    }
                }
