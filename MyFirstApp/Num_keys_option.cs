...
{
    public partial class Num_keys_option : Form
    {
        public Num_keys_option()
        {
            InitializeComponent();
        }
        ...
        // Button that starts 'Num_keys' lesson with setting given
        private void Start_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                var num = new Num_keys(Int32.Parse(typeAmount.Text));
                num.Show();
