...
{
    public partial class Uppercase_3_option : Form
    {
        public Uppercase_3_option()
        {
            InitializeComponent();
        }
        ...
        // Button that starts 'Uppercase_3' lesson with setting given
        private void Start_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                var uc3 = new Uppercase_3(Int32.Parse(typeAmount.Text));
                uc3.Show();
