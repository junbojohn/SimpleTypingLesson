...
{
    public partial class Basic_2_option : Form
    {
        public Basic_2_option()
        {
            InitializeComponent();
        }
        ...
        // Button that starts 'Basic_2' lesson with setting given
        private void Start_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                var b2 = new Basic_2(Int32.Parse(typeAmount.Text));
                b2.Show();
